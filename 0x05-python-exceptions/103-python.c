...
/**
 * print_python_float - this give date of the PyFloatObject
 * @p: the PyObject
 *
 */
void print_python_list(PyObject *p)
{
	...
	string = PyOS_double_to_string(value, 'r', 0, Py_DTSF__ADD_DOT_O, NULL)
		printf(" value: %s\n", string);
}

/**
 * print_python_bytes - this prints the data of the PyBytesObject
