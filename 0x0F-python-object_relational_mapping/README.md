...
4. Yes, it’s an SQL injection to delete all records of a table…
...
11. Write a script that prints the State object with the name passed as argument from the database hbtn_0e_6_usa
...
12. Write a script that adds the State object “Louisiana” to the database hbtn_0e_6_usa
...
13. Write a script that changes the name of a State object from the database hbtn_0e_6_usa
...
14. Write a script that deletes all State objects with a name containing the letter a from the database hbtn_0e_6_usa
...
15. Write a Python file similar to model_state.py named model_city.py that contains the class definition of a City.
...
17. Write a script that lists all State objects, and corresponding City objects, contained in the database hbtn_0e_101_usa
...
18. Write a script that lists all City objects from the database hbtn_0e_101_usa
